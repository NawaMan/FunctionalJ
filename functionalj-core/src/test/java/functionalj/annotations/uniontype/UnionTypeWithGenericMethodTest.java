...
import static functionalj.annotations.uniontype.Option.None;
...
//        assertEquals("Just:Hey!",       Some("Hey!").toString());
...
//        assertEquals("Just:4", "" + Option.of("Hey!").map(String::valueOf).map(String::length));
//    }
//    @Test
//    public void testFlatMap() {
//        assertEquals("None",   "" + Option.of(null)  .map(String::valueOf).flatMap(s -> Option.of(s.length())));
//        assertEquals("Just:4", "" + Option.of("Hey!").map(String::valueOf).flatMap(s -> Option.of(s.length())));
//    }
//    @Test
//    public void testGet() {
