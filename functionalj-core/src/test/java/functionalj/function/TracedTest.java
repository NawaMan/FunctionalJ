...
public class TracedTest {
    ...
    public void testTraced() {
        ...
        assertEquals("Func1::F1",                                        TracedConstants.namedNoTracedFunc1.toString());
        assertEquals("Func1::F2@functionalj.function.TracedConstants#9", TracedConstants.namedTracedFunc1  .toString());
        assertEquals("Func1@functionalj.function.TracedConstants#10",    TracedConstants.nonameTracedFunc1 .toString());
    }
    @Test
    public void testName() {
        ...
        assertEquals("Func1",      ((Named)TracedConstants.nonameTracedFunc1) .getName());
    }
