...
public class DeferValueTest {
    ...
    public void testAssign() {
        ...
        try { defer.assignOrThrow("very-bad-value"); fail(); } catch (Exception e) {}
        assertEquals("Result:{ Value: good-value }", "" + defer.getCurrentResult());
    }
    ...
    public void testFail() {
        ...
        try { defer.failOrThrow(new  IllegalAccessException()); fail(); } catch (Exception e) {}
        assertEquals("Result:{ Exception: java.lang.NullPointerException }", "" + defer.getCurrentResult());
    }
    ...
    public void testComplete_connect_abort() {
        ...
        val defer1 = DeferValue.of(String.class)      .ifAbsent(() -> logs.add("defer1: absent"))
                                                      .ifNull(() -> logs.add("defer1: null"));
        val defer2 = defer1.whenAbsentUse("default-2").whenAbsentUse("default-2");
        val defer3 = defer1.whenAbsentUse("default-3").whenNullUse("default-3")
                                                      .ifNull(() -> logs.add("defer3: null"));
