...
/**
 * Monadic Function of three parameters.
 *
 ...
 */
@FunctionalInterface
public interface MFunc3<INPUT1, INPUT2, INPUT3, MONAD, OUTPUT> extends Func3<INPUT1, INPUT2, INPUT3, Monad<MONAD, OUTPUT>> {
     ...
     */
    public default <FINAL> MFunc3<INPUT1, INPUT2, INPUT3, MONAD, FINAL> 
