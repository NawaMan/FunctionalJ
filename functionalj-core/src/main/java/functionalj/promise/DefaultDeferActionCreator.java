...
public class DefaultDeferActionCreator implements DeferActionCreator {
    
    public static final DefaultDeferActionCreator instance = new DefaultDeferActionCreator();
