...
public interface Tuple5<T1, T2, T3, T4, T5> extends Pipeable<Tuple5<T1, T2, T3, T4, T5>> {
    ...
    public default FunctionalList<Object> toList() {
        ...
        val _4 = _4();
        val _5 = _5();
        return FunctionalList.of(_1, _2, _3, _4, _5);
    }
    
    public default <K> FunctionalMap<K, Object> toMap(K k1, K k2, K k3, K k4, K k5) {
    ...
    public default <NT1, NT2, NT3, NT4, NT5> Tuple5<NT1, NT2, NT3, NT4, NT5> mapEach(
        ...
        return Tuple.of(n1, n2, n3, n4, n5);
    }
