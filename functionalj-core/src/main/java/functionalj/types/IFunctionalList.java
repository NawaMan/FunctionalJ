...
public interface IFunctionalList<DATA, SELF extends IFunctionalList<DATA, SELF>> 
    ...
    public static <T> IFunctionalList<T, ?> of(ICanStream<T, ?> icanStream) {
    ...
    public static <T> IFunctionalList<T, ?> of(IList<T, ?> iList) {
        return ImmutableList.of(iList);
    }
    
    public static <T> IFunctionalList<T, ?> listOf(T ... data) {
        return ImmutableList.of(data);
    }
    ...
    public default ImmutableList<DATA> toImmutableList() {
        return ImmutableList.of((ICanStream<DATA, ?>)this);
    }
