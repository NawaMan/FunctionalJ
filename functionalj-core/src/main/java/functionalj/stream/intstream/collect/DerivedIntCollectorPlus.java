...
abstract public class DerivedIntCollectorPlus<ACCUMULATED, TARGET> {
    ...
    public static class FromObj<INPUT, ACCUMULATED, TARGET> 
                        extends DerivedIntCollectorPlus<ACCUMULATED, TARGET>
                        implements CollectorPlus<INPUT, ACCUMULATED, TARGET> {
        
        private final ToIntFunction<INPUT> mapper;
        
        public <SOURCE> FromObj(IntCollectorPlus<ACCUMULATED, TARGET> collector, 
    ...
    public static class FromInt<ACCUMULATED, TARGET> 
        ...
        public FromInt(IntCollectorPlus<ACCUMULATED, TARGET> collector, 
    ...
    public static class FromLong<ACCUMULATED, TARGET> 
        ...
        public FromLong(IntCollectorPlus<ACCUMULATED, TARGET> collector,
    ...
    public static class FromDouble<ACCUMULATED, TARGET> 
        ...
        public FromDouble(IntCollectorPlus<ACCUMULATED, TARGET> collector,
