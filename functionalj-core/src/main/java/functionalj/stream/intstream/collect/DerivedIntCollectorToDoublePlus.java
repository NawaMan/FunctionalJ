...
abstract public class DerivedIntCollectorToDoublePlus<ACCUMULATED> {
    ...
    public static class FromObj<INPUT, ACCUMULATED> 
                        extends DerivedIntCollectorToDoublePlus<ACCUMULATED>
                        implements CollectorToDoublePlus<INPUT, ACCUMULATED> {
        
        private final ToIntFunction<INPUT> mapper;
        
        public FromObj(IntCollectorToDoublePlus<ACCUMULATED> collector,
    ...
    public static class FromInt<ACCUMULATED> 
        ...
        public <SOURCE> FromInt(IntCollectorToDoublePlus<ACCUMULATED> collector, 
    ...
    public static class FromLong<ACCUMULATED> 
        ...
        public FromLong(IntCollectorToDoublePlus<ACCUMULATED> collector, 
    ...
    public static class FromDouble<ACCUMULATED> 
        ...
        public FromDouble(IntCollectorToDoublePlus<ACCUMULATED> collector, 
