...
abstract public class DerivedDoubleCollectorPlus<ACCUMULATED, TARGET> {
    ...
    public static class FromObj<INPUT, ACCUMULATED, TARGET> 
                        extends DerivedDoubleCollectorPlus<ACCUMULATED, TARGET>
                        implements CollectorPlus<INPUT, ACCUMULATED, TARGET> {
        
        private final ToDoubleFunction<INPUT> mapper;
        
        public <SOURCE> FromObj(DoubleCollectorPlus<ACCUMULATED, TARGET> collector, 
    ...
    public static class FromInt<ACCUMULATED, TARGET> 
        ...
        public FromInt(DoubleCollectorPlus<ACCUMULATED, TARGET> collector, 
    ...
    public static class FromLong<ACCUMULATED, TARGET> 
        ...
        public FromLong(DoubleCollectorPlus<ACCUMULATED, TARGET> collector,
    ...
    public static class FromDouble<ACCUMULATED, TARGET> 
        ...
        public FromDouble(DoubleCollectorPlus<ACCUMULATED, TARGET> collector,
