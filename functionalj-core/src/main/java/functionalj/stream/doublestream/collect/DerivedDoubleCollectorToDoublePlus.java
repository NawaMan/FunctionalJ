...
abstract public class DerivedDoubleCollectorToDoublePlus<ACCUMULATED> {
    ...
    public static class FromObj<INPUT, ACCUMULATED> 
                        extends DerivedDoubleCollectorToDoublePlus<ACCUMULATED>
                        implements CollectorToDoublePlus<INPUT, ACCUMULATED> {
        
        private final ToDoubleFunction<INPUT> mapper;
        
        public FromObj(DoubleCollectorToDoublePlus<ACCUMULATED> collector,
    ...
    public static class FromInt<ACCUMULATED> 
                        extends DerivedDoubleCollectorToDoublePlus<ACCUMULATED>
                        implements IntCollectorToDoublePlus<ACCUMULATED> {
        
        private final IntToDoubleFunction mapper;
        
        public <SOURCE> FromInt(DoubleCollectorToDoublePlus<ACCUMULATED> collector, 
    ...
    public static class FromLong<ACCUMULATED> 
                        extends DerivedDoubleCollectorToDoublePlus<ACCUMULATED>
                        implements LongCollectorToDoublePlus<ACCUMULATED> {
        
        private final LongToDoubleFunction mapper;
        
        public FromLong(DoubleCollectorToDoublePlus<ACCUMULATED> collector, 
    ...
    public static class FromDouble<ACCUMULATED> 
                        extends DerivedDoubleCollectorToDoublePlus<ACCUMULATED>
                        implements DoubleCollectorToDoublePlus<ACCUMULATED> {
        
        private final DoubleUnaryOperator mapper;
        
        public FromDouble(DoubleCollectorToDoublePlus<ACCUMULATED> collector, 
