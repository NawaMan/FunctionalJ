...
abstract public class DerivedDoubleCollectorToLongPlus<ACCUMULATED> {
    ...
    public static class FromObj<INPUT, ACCUMULATED> 
                        extends DerivedDoubleCollectorToLongPlus<ACCUMULATED>
                        implements CollectorToLongPlus<INPUT, ACCUMULATED> {
        
        private final ToDoubleFunction<INPUT> mapper;
        
        public FromObj(DoubleCollectorToLongPlus<ACCUMULATED> collector,
    ...
    public static class FromInt<ACCUMULATED> 
        ...
        public <SOURCE> FromInt(DoubleCollectorToLongPlus<ACCUMULATED> collector, 
    ...
    public static class FromLong<ACCUMULATED> 
        ...
        public FromLong(DoubleCollectorToLongPlus<ACCUMULATED> collector, 
    ...
    public static class FromDouble<ACCUMULATED> 
        ...
        public FromDouble(DoubleCollectorToLongPlus<ACCUMULATED> collector, 
