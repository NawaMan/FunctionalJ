...
abstract public class DerivedDoubleCollectorToIntPlus<ACCUMULATED> {
    ...
    public static class FromObj<INPUT, ACCUMULATED> 
                        extends DerivedDoubleCollectorToIntPlus<ACCUMULATED>
                        implements CollectorToIntPlus<INPUT, ACCUMULATED> {
        
        private final ToDoubleFunction<INPUT> mapper;
        
        public FromObj(DoubleCollectorToIntPlus<ACCUMULATED> collector,
    ...
    public static class FromInt<ACCUMULATED> 
        ...
        public <SOURCE> FromInt(DoubleCollectorToIntPlus<ACCUMULATED> collector, 
    ...
    public static class FromLong<ACCUMULATED> 
        ...
        public FromLong(DoubleCollectorToIntPlus<ACCUMULATED> collector, 
    ...
    public static class FromDouble<ACCUMULATED> 
        ...
        public FromDouble(DoubleCollectorToIntPlus<ACCUMULATED> collector, 
