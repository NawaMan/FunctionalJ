...
abstract public class DerivedLongCollectorToDoublePlus<ACCUMULATED> {
    ...
    public static class FromObj<INPUT, ACCUMULATED> 
                        extends DerivedLongCollectorToDoublePlus<ACCUMULATED>
                        implements CollectorToDoublePlus<INPUT, ACCUMULATED> {
        
        private final ToLongFunction<INPUT> mapper;
        
        public FromObj(LongCollectorToDoublePlus<ACCUMULATED> collector,
    ...
    public static class FromInt<ACCUMULATED> 
        ...
        public <SOURCE> FromInt(LongCollectorToDoublePlus<ACCUMULATED> collector, 
    ...
    public static class FromLong<ACCUMULATED> 
        ...
        public FromLong(LongCollectorToDoublePlus<ACCUMULATED> collector, 
    ...
    public static class FromDouble<ACCUMULATED> 
        ...
        public FromDouble(LongCollectorToDoublePlus<ACCUMULATED> collector, 
