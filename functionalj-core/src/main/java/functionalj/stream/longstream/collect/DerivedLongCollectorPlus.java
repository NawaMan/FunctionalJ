...
abstract public class DerivedLongCollectorPlus<ACCUMULATED, TARGET> {
    ...
    public static class FromObj<INPUT, ACCUMULATED, TARGET> 
                        extends DerivedLongCollectorPlus<ACCUMULATED, TARGET>
                        implements CollectorPlus<INPUT, ACCUMULATED, TARGET> {
        
        private final ToLongFunction<INPUT> mapper;
        
        public <SOURCE> FromObj(LongCollectorPlus<ACCUMULATED, TARGET> collector, 
    ...
    public static class FromInt<ACCUMULATED, TARGET> 
        ...
        public FromInt(LongCollectorPlus<ACCUMULATED, TARGET> collector, 
    ...
    public static class FromLong<ACCUMULATED, TARGET> 
        ...
        public FromLong(LongCollectorPlus<ACCUMULATED, TARGET> collector,
    ...
    public static class FromDouble<ACCUMULATED, TARGET> 
        ...
        public FromDouble(LongCollectorPlus<ACCUMULATED, TARGET> collector,
