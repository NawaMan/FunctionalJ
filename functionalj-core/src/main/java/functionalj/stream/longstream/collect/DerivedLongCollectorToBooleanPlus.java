...
abstract public class DerivedLongCollectorToBooleanPlus<ACCUMULATED> {
    ...
    public static class FromObj<INPUT, ACCUMULATED> 
                        extends DerivedLongCollectorToBooleanPlus<ACCUMULATED>
                        implements CollectorToBooleanPlus<INPUT, ACCUMULATED> {
        
        private final ToLongFunction<INPUT> mapper;
        
        public FromObj(LongCollectorToBooleanPlus<ACCUMULATED> collector,
    ...
    public static class FromInt<ACCUMULATED> 
        ...
        public <SOURCE> FromInt(LongCollectorToBooleanPlus<ACCUMULATED> collector, 
    ...
    public static class FromLong<ACCUMULATED> 
        ...
        public FromLong(LongCollectorToBooleanPlus<ACCUMULATED> collector, 
    ...
    public static class FromDouble<ACCUMULATED> 
        ...
        public FromDouble(LongCollectorToBooleanPlus<ACCUMULATED> collector, 
