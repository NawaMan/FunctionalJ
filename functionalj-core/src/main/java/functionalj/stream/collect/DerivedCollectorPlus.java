...
abstract public class DerivedCollectorPlus<ACCUMULATED, TARGET> {
    ...
    public static class FromObj<INPUT, ACCUMULATED, TARGET> 
                            extends DerivedCollectorPlus<ACCUMULATED, TARGET>
                            implements CollectorPlus<INPUT, ACCUMULATED, TARGET> {
        
        private final Function<INPUT, ?> mapper;
        
        public <SOURCE> FromObj(Collector<SOURCE, ACCUMULATED, TARGET> collector, 
    ...
    public static class FromInt<ACCUMULATED, TARGET> 
                        extends DerivedCollectorPlus<ACCUMULATED, TARGET>
                        implements IntCollectorPlus<ACCUMULATED, TARGET> {
        
        private final IntFunction<?> mapper;
        
        public <SOURCE> FromInt(Collector<SOURCE, ACCUMULATED, TARGET> collector, 
    ...
    public static class FromLong<ACCUMULATED, TARGET> 
                            extends DerivedCollectorPlus<ACCUMULATED, TARGET>
                            implements LongCollectorPlus<ACCUMULATED, TARGET> {
        
        private final LongFunction<?> mapper;
        
        public <SOURCE> FromLong(Collector<SOURCE, ACCUMULATED, TARGET> collector, 
    ...
    public static class FromDouble<ACCUMULATED, TARGET> 
                    extends DerivedCollectorPlus<ACCUMULATED, TARGET>
                    implements DoubleCollectorPlus<ACCUMULATED, TARGET> {
        
        private final DoubleFunction<?> mapper;
        
        public <SOURCE> FromDouble(Collector<SOURCE, ACCUMULATED, TARGET> collector, 
