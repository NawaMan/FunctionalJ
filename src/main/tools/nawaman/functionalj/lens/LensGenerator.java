...
import static nawaman.functionalj.lens.LensGenerator.Accessibility.PRIVATE;
import static nawaman.functionalj.lens.LensGenerator.Accessibility.PUBLIC;
import static nawaman.functionalj.lens.LensGenerator.ILines.indent;
import static nawaman.functionalj.lens.LensGenerator.ILines.line;
import static nawaman.functionalj.lens.LensGenerator.Modifiability.FINAL;
import static nawaman.functionalj.lens.LensGenerator.Modifiability.MODIFIABLE;
import static nawaman.functionalj.lens.LensGenerator.Scope.INSTANCE;
...
public class LensGenerator {
    ...
    public static void main(String[] args) {
        val stringType  = new Type("String", "java.lang");
        val colorGetter = new Getter("color", stringType);
        val makeGetter  = new Getter("make", stringType);
        val modelGetter = new Getter("model", stringType);
        
        val carSpec = new Spec(
                "ICar", "nawaman.functionalj.lens.LensGenerator",
                "Car",  "nawaman.functionalj.lens",
                false,
                asList(colorGetter, makeGetter, modelGetter));
        
        val sourceSpec = carSpec;
        
        val recordSpec  = generateRecordSpec(sourceSpec);
        val recordClass = generateRecordClass(recordSpec);
        recordClass.forEach(System.out::println);
    }
...
//                line(),
    ...
    private static Stream<String> generateRecordClass(RecordSpec recordSpec) {
    ...
    private static nawaman.functionalj.lens.LensGenerator.RecordSpec generateRecordSpec(Spec sourceSpec) {
        ...
        val withMethodName = Func1.of(LensGenerator::withMethodName);
