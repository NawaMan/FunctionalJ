...
```Groovy
    compile             'io.functionalj:functionalj-all:1.0.25'   // Please lookup for the latest version.
    annotationProcessor 'io.functionalj:functionalj-types:1.0.25' // Please lookup for the latest version.
```
