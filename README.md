...
```Groovy
    compile             'io.functionalj:functionalj-all:0.3.0.0'   // Please lookup for the latest version.
    annotationProcessor 'io.functionalj:functionalj-types:0.3.0.0' // Please lookup for the latest version.
```
