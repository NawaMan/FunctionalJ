...
import functionalj.types.choice.Command;
...
// functionalj.types.choice.ChoiceToMapTest.null
...
public class TimedAction implements IStruct,Pipeable<TimedAction> {
    ...
    public TimedAction(LocalDateTime time, FuncList<Command> commands) {
        ...
        this.commands = ImmutableList.from(commands);
    ...
    public TimedAction withCommands(Command ... commands) {
        return new TimedAction(time, functionalj.list.ImmutableList.of(commands));
    }
    ...
    public static TimedAction fromMap(Map<String, Object> map) {
