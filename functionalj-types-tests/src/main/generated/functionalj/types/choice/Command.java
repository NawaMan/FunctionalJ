...
// functionalj.types.choice.ChoiceToMapTest.CommandModel
...
public abstract class Command implements IChoice<Command.CommandFirstSwitch>, Pipeable<Command> {
    ...
    public static <T extends Command> T fromMap(java.util.Map<String, Object> map) {
    ...
    public static final class Rotate extends Command {
        ...
        public static Rotate caseFromMap(java.util.Map<String, Object> map) {
            return Rotate(
    ...
    public static final class Move extends Command {
        ...
        public static Move caseFromMap(java.util.Map<String, Object> map) {
            return Move(
    ...
    public static class CommandFirstSwitch {
        ...
        public <TARGET> CommandSwitchRotateMove<TARGET> rotate(Predicate<Rotate> check, Function<? super Rotate, ? extends TARGET> theAction) {
            Function<Command, TARGET> $action = null;
            Function<Command, TARGET> oldAction = (Function<Command, TARGET>)$action;
            Function<Command, TARGET> newAction =
                ($action != null)
        ...
        public <TARGET> CommandSwitchRotateMove<TARGET> rotate(Predicate<Rotate> check, Supplier<? extends TARGET> theSupplier) {
            return rotate(check, d->theSupplier.get());
        }
        public <TARGET> CommandSwitchRotateMove<TARGET> rotate(Predicate<Rotate> check, TARGET theValue) {
    ...
    public static class CommandFirstSwitchTyped<TARGET> {
        ...
        public CommandSwitchRotateMove<TARGET> rotate(Predicate<Rotate> check, Function<? super Rotate, ? extends TARGET> theAction) {
            Function<Command, TARGET> $action = null;
            Function<Command, TARGET> oldAction = (Function<Command, TARGET>)$action;
            Function<Command, TARGET> newAction =
                ($action != null)
        ...
        public CommandSwitchRotateMove<TARGET> rotate(Predicate<Rotate> check, Supplier<? extends TARGET> theSupplier) {
            return rotate(check, d->theSupplier.get());
        }
        public CommandSwitchRotateMove<TARGET> rotate(Predicate<Rotate> check, TARGET theValue) {
            return rotate(check, d->theValue);
        }
    }
    ...
    public static class CommandSwitchMove<TARGET> extends ChoiceTypeSwitch<Command, TARGET> {
        ...
        public CommandSwitchMove<TARGET> move(Predicate<Move> check, Function<? super Move, ? extends TARGET> theAction) {
            Function<Command, TARGET> oldAction = (Function<Command, TARGET>)$action;
            Function<Command, TARGET> newAction =
                ($action != null)
                ? oldAction : 
        ...
        public CommandSwitchMove<TARGET> move(Predicate<Move> check, Supplier<? extends TARGET> theSupplier) {
            return move(check, d->theSupplier.get());
        }
        public CommandSwitchMove<TARGET> move(Predicate<Move> check, TARGET theValue) {
