...
// functionalj.types.struct.WithFuncListTest.WithFuncListTest.IParent2
...
public class ParentWithFuncList implements WithFuncListTest.IParent2,IStruct,Pipeable<ParentWithFuncList> {
    ...
    public ParentWithFuncList withNames(String ... names) {
        return new ParentWithFuncList(functionalj.list.ImmutableList.of(names), children);
    }
    ...
    public ParentWithFuncList withChildren(Child ... children) {
        return new ParentWithFuncList(names, functionalj.list.ImmutableList.of(children));
    }
    ...
    public static ParentWithFuncList fromMap(Map<String, Object> map) {
