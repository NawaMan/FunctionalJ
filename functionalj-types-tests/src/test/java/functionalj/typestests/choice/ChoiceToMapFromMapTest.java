...
//        void bigDecimalValue(BigDecimal myBigDecimal);
     ...
     **/
    @Test
    public void testPrimitiveFromString_byte() {
        val myChoice1 = MyPrimitiveChoice.ByteValue((byte)   1,     (byte)   2);
        System.out.println(myChoice1.__toMap());
//        val myStruct1 = new MyPrimitiveChoice(
//                        (byte)   1,     (byte)   2, 
//                        (short)  3,     (short)  4, 
//                        (int)    5,     (int)    6, 
//                        (long)   7L,    (long)   8L, 
