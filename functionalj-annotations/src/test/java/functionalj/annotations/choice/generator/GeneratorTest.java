...
import static functionalj.annotations.choice.generator.model.Method.Kind.STATIC;
...
@ExtensionMethod(functionalj.annotations.choice.generator.Utils.class)
...
public class GeneratorTest {
    ...
    public void testSubClassConstructor_noParams() {
        ...
        assertEquals(
                ...
                "}", lines);
        assertEquals(
                "new functionalj.annotations.choice.generator.model.SourceSpec("
                    + "\"Color\", "
                    + "new functionalj.annotations.choice.generator.model.Type("
                        + "\"p1.p2\", "
                        + "null, "
                        + "\"ColorSpec\", "
