...
import static functionalj.annotations.sealed.generator.model.Method.Kind.DEFAULT;
import static functionalj.annotations.sealed.generator.model.Method.Kind.STATIC;
...
import functionalj.annotations.sealed.generator.SourceMethod;
import functionalj.annotations.sealed.generator.SubCheckMethod;
import functionalj.annotations.sealed.generator.SubClassConstructor;
import functionalj.annotations.sealed.generator.SubClassDefinition;
import functionalj.annotations.sealed.generator.SwitchClass;
import functionalj.annotations.sealed.generator.TargetClass;
import functionalj.annotations.sealed.generator.TargetTypeGeneral;
...
import functionalj.annotations.sealed.generator.model.MethodParam;
...
import functionalj.annotations.sealed.generator.model.Method.Kind;
import lombok.val;
import lombok.experimental.ExtensionMethod;


@ExtensionMethod(functionalj.annotations.sealed.generator.Utils.class)
...
public class GeneratorTest {
    ...
    public void testSubClassConstructor_noParams() {
        ...
        assertEquals(
                ...
                "}", lines);
        assertEquals(
                "new functionalj.annotations.sealed.generator.model.SourceSpec("
                    + "\"Color\", "
                    + "new functionalj.annotations.sealed.generator.model.Type("
                        + "\"p1.p2\", "
                        + "null, "
                        + "\"ColorSpec\", "
    ...
    public void testSubClassConstructor_withParams_withGeneric() {
        ...
        assertEquals(
                ...
                "}", lines);
        assertEquals(
                "new functionalj.annotations.sealed.generator.model.SourceSpec(\"Coroutine\", new functionalj.annotations.sealed.generator.model.Type(\"p1.p2\", null, \"Next\", java.util.Arrays.asList(new functionalj.annotations.sealed.generator.model.Generic(\"D\", \"D\", null))), \"spec\", false, java.util.Arrays.asList(new functionalj.annotations.sealed.generator.model.Generic(\"D\", \"D\", null)), java.util.Collections.emptyList(), java.util.Collections.emptyList())", sourceSpec.toCode());
    }
    ...
    public void testSwitchClass_simple_notLast() {
        ...
        val lines  = sub.lines().stream().filter(Objects::nonNull).collect(Collectors.joining("\n"));
        assertEquals(
                "public static class ColorSwitchWhiteBlackRGB<TARGET> extends SealedClassSwitch<Color, TARGET> {\n" + 
    ...
    public void testSwitchClass_simple_last() {
        ...
        val lines  = sub.lines().stream().filter(Objects::nonNull).collect(Collectors.joining("\n"));
        assertEquals(
                "public static class ColorSwitchWhite<TARGET> extends SealedClassSwitch<Color, TARGET> {\n" + 
    ...
    public void testSwitchClass_expand() {
        ...
        val lines  = sub.lines().stream().filter(Objects::nonNull).collect(Collectors.joining("\n"));
        assertEquals(
                "public static class ColorSwitchRGB<TARGET> extends SealedClassSwitch<Color, TARGET> {\n" + 
