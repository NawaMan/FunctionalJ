...
//  public static interface SealedClass1TypeSpec {
//      void White();
//      void Black();
...
//  }
  ...
  public static void main(String[] args) {
      val generator = new Generator(
              "BasicColor",
              new Type("functionalj.annotations.sealed.generator", "SealedClassTypeExampleTest", "SealedClass1TypeSpec"),
              "spec",
              true,
              asList(),
              asList(
  ...
  public void testGenerator() {
      ...
      assertEquals(
              ...
              "import functionalj.annotations.sealed.generator.SealedClassTypeExampleTest.SealedClass1TypeSpec;\n" + 
              ...
              "public abstract class BasicColor extends AbstractSealedClass<BasicColor.BasicColorFirstSwitch> implements Pipeable<BasicColor> {\n" + 
              "    \n" + 
              ...
              "        SealedClass1TypeSpec.__validateRGB(r, g, b);\n" + 
              ...
              "        }\n" + 
              "    }\n" + 
              "    public static class BasicColorSwitchWhiteBlackRGB<TARGET> extends SealedClassSwitch<BasicColor, TARGET> {\n" + 
              ...
              "        }\n" + 
              "    }\n" + 
              "    public static class BasicColorSwitchBlackRGB<TARGET> extends SealedClassSwitch<BasicColor, TARGET> {\n" + 
              ...
              "        }\n" + 
              "    }\n" + 
              "    public static class BasicColorSwitchRGB<TARGET> extends SealedClassSwitch<BasicColor, TARGET> {\n" + 
