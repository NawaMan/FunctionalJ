...
public abstract class BasicColor extends AbstractSealedClass<BasicColor.BasicColorFirstSwitch> {
    ...
    public static final BasicColor RGB(int r, int g, int b) {
        SealedClassExampleTest.Sealed1TypeSpec.__validateRGB(r, g, b);
    ...
    public static class BasicColorSwitchWhiteBlackRGB<T> extends SealedClassSwitch<BasicColor, T> {
    ...
    public static class BasicColorSwitchBlackRGB<T> extends SealedClassSwitch<BasicColor, T> {
    ...
    public static class BasicColorSwitchRGB<T> extends SealedClassSwitch<BasicColor, T> {
