...
public class FirstSubWithOnlyParamTest {
    ...
    public void test() {
        val spec = new SourceSpec(
                "BasicColor",
                new Type("functionalj.annotations.sealed.generator", "SealedClassExampleTest", "SealedClass1TypeSpec"),
                asList(
        ...
        assertEquals(
                ...
                "    }\n" + 
                "}\n" + 
                "public static class BasicColorSwitchRGBWhite<TARGET> extends SealedClassSwitch<BasicColor, TARGET> {\n" + 
