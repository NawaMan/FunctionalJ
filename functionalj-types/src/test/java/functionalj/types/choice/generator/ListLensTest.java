...
public class ListLensTest {
    ...
    public void testListLens_custom() {
        ...
        assertAsString(
                ...
                + "    \n"
                + "    \n"
                + "    public static final NestedCommandLens<NestedCommand> theNestedCommand = new NestedCommandLens<>(LensSpec.of(NestedCommand.class));\n"
                ...
                + "        public final ResultAccess<HOST, Rotate, Rotate.RotateLens<HOST>> asRotate = createSubResultLens(NestedCommand::asRotate, (functionalj.lens.core.WriteLens<NestedCommand,Result<Rotate>>)null, Rotate.RotateLens::new);\n"
                + "        public final ResultAccess<HOST, Move, Move.MoveLens<HOST>> asMove = createSubResultLens(NestedCommand::asMove, (functionalj.lens.core.WriteLens<NestedCommand,Result<Move>>)null, Move.MoveLens::new);\n"
                + "        public final ResultAccess<HOST, Commands, Commands.CommandsLens<HOST>> asCommands = createSubResultLens(NestedCommand::asCommands, (functionalj.lens.core.WriteLens<NestedCommand,Result<Commands>>)null, Commands.CommandsLens::new);\n"
                + "        public NestedCommandLens(LensSpec<HOST, NestedCommand> spec) {\n"
                + "            super(spec);\n"
                + "        }\n"
                + "    }\n"
                + "    \n"
                ...
                + "            \n"
                + "            public final IntegerLens<HOST> degree = createSubLensInt(NestedCommand.Rotate::degree, NestedCommand.Rotate::withDegree);\n"
                + "            \n"
                + "            public RotateLens(LensSpec<HOST, NestedCommand.Rotate> spec) {\n"
                + "                super(spec);\n"
                + "            }\n"
                + "            \n"
                + "        }\n"
                ...
                + "            map.put(\"__tagged\", functionalj.types.IData.$utils.toMapValueObject(\"Rotate\"));\n"
                ...
                + "            \n"
                + "            public final IntegerLens<HOST> distance = createSubLensInt(NestedCommand.Move::distance, NestedCommand.Move::withDistance);\n"
                + "            \n"
                + "            public MoveLens(LensSpec<HOST, NestedCommand.Move> spec) {\n"
                + "                super(spec);\n"
                + "            }\n"
                + "            \n"
                + "        }\n"
                + "        public java.util.Map<String, Object> __toMap() {\n"
                + "            java.util.Map<String, Object> map = new java.util.HashMap<>();\n"
                + "            map.put(\"__tagged\", functionalj.types.IData.$utils.toMapValueObject(\"Move\"));\n"
                ...
                + "        public static final Commands.CommandsLens<Commands> theCommands = new Commands.CommandsLens<>(LensSpec.of(Commands.class));\n"
                ...
                + "            \n"
                + "            public CommandsLens(LensSpec<HOST, NestedCommand.Commands> spec) {\n"
                + "                super(spec);\n"
                + "            }\n"
                + "            \n"
                + "        }\n"
                + "        public java.util.Map<String, Object> __toMap() {\n"
                + "            java.util.Map<String, Object> map = new java.util.HashMap<>();\n"
                + "            map.put(\"__tagged\", functionalj.types.IData.$utils.toMapValueObject(\"Commands\"));\n"
                ...
                + "            return Commands(\n"
                + "                $utils.propertyFromMap(map, __schema__, \"commands\")\n"
                + "            );\n"
                + "        }\n"
                + "    }\n"
                + "    \n"
