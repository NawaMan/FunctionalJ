...
public class UnitOfMeasureGeneratorTest {
    ...
    public void test() {
        ...
        val expect = 
                ...
                + "    }\n"
                + "    \n"
                + "    private final transient TemperatureFirstSwitch __switch = new TemperatureFirstSwitch(this);\n"
                ...
                + "        }\n"
                + "        \n"
                + "        public <TARGET> TemperatureSwitchCelsiusFahrenheit<TARGET> celsius(java.util.function.Predicate<Celsius> check, Function<? super Celsius, ? extends TARGET> theAction) {\n"
                + "            Function<Temperature, TARGET> $action = null;\n"
                + "            Function<Temperature, TARGET> oldAction = (Function<Temperature, TARGET>)$action;\n"
                + "            Function<Temperature, TARGET> newAction =\n"
                + "                ($action != null)\n"
                ...
                + "        }\n"
                + "        public <TARGET> TemperatureSwitchCelsiusFahrenheit<TARGET> celsius(java.util.function.Predicate<Celsius> check, Supplier<? extends TARGET> theSupplier) {\n"
                + "            return celsius(check, d->theSupplier.get());\n"
                + "        }\n"
                + "        public <TARGET> TemperatureSwitchCelsiusFahrenheit<TARGET> celsius(java.util.function.Predicate<Celsius> check, TARGET theValue) {\n"
                ...
                + "        }\n"
                + "        \n"
                + "        public TemperatureSwitchCelsiusFahrenheit<TARGET> celsius(java.util.function.Predicate<Celsius> check, Function<? super Celsius, ? extends TARGET> theAction) {\n"
                + "            Function<Temperature, TARGET> $action = null;\n"
                + "            Function<Temperature, TARGET> oldAction = (Function<Temperature, TARGET>)$action;\n"
                + "            Function<Temperature, TARGET> newAction =\n"
                + "                ($action != null)\n"
                ...
                + "            return new TemperatureSwitchCelsiusFahrenheit<TARGET>($value, newAction);\n"
                + "        }\n"
                + "        public TemperatureSwitchCelsiusFahrenheit<TARGET> celsius(java.util.function.Predicate<Celsius> check, Supplier<? extends TARGET> theSupplier) {\n"
                + "            return celsius(check, d->theSupplier.get());\n"
                + "        }\n"
                + "        public TemperatureSwitchCelsiusFahrenheit<TARGET> celsius(java.util.function.Predicate<Celsius> check, TARGET theValue) {\n"
                + "            return celsius(check, d->theValue);\n"
                + "        }\n"
                + "    }\n"
                ...
                + "        }\n"
                + "        \n"
                + "        public TemperatureSwitchFahrenheit<TARGET> fahrenheit(java.util.function.Predicate<Fahrenheit> check, Function<? super Fahrenheit, ? extends TARGET> theAction) {\n"
                + "            Function<Temperature, TARGET> oldAction = (Function<Temperature, TARGET>)$action;\n"
                + "            Function<Temperature, TARGET> newAction =\n"
                + "                ($action != null)\n"
                + "                ? oldAction : \n"
                ...
                + "            return new TemperatureSwitchFahrenheit<TARGET>($value, newAction);\n"
                + "        }\n"
                + "        public TemperatureSwitchFahrenheit<TARGET> fahrenheit(java.util.function.Predicate<Fahrenheit> check, Supplier<? extends TARGET> theSupplier) {\n"
                + "            return fahrenheit(check, d->theSupplier.get());\n"
                + "        }\n"
                + "        public TemperatureSwitchFahrenheit<TARGET> fahrenheit(java.util.function.Predicate<Fahrenheit> check, TARGET theValue) {\n"
                ...
                + "    \n"
                + "}";
        TestHelper.assertAsString(expect, code);
    }
