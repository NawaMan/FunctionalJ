...
public class ListLensTest {
    ...
    public void testListLens_unTyped() {
        ...
        assertAsString(
                ...
                + "                    (List)$utils.fromMapValue(map.get(\"child\"), $schema.get(\"child\"))\n"
                + "                );\n"
                + "        return obj;\n"
                + "    }\n"
                ...
                + "        \n"
                + "        public final ListLens<HOST, Object, ObjectLens<HOST, Object>> child = createSubListLens(Person::child, Person::withChild, ObjectLens::of);\n"
                + "        \n"
    ...
    public void testListLens_typed() {
        ...
        assertAsString(
                ...
                + "        Map<String, Getter> $schema = getStructSchema();\n"
                + "        Person obj = new Person(\n"
                + "                    (List<BigInteger>)$utils.fromMapValue(map.get(\"children\"), $schema.get(\"children\"))\n"
                + "                );\n"
                + "        return obj;\n"
                + "    }\n"
                + "    public Map<String, Object> __toMap() {\n"
                ...
                + "    public static class PersonLens<HOST> extends ObjectLensImpl<HOST, Person> {\n"
                + "        \n"
                + "        public final ListLens<HOST, BigInteger, BigIntegerLens<HOST>> children = createSubListLens(Person::children, Person::withChildren, BigIntegerLens::of);\n"
                + "        \n"
                + "        public PersonLens(LensSpec<HOST, Person> spec) {\n"
                + "            super(spec);\n"
                + "        }\n"
    ...
    public void testListLens_typed_nested() {
        ...
        assertAsString(
                ...
                + "        Map<String, Getter> $schema = getStructSchema();\n"
                + "        Person obj = new Person(\n"
                + "                    (List<List<Object>>)$utils.fromMapValue(map.get(\"children\"), $schema.get(\"children\"))\n"
                + "                );\n"
                + "        return obj;\n"
                + "    }\n"
                + "    public Map<String, Object> __toMap() {\n"
                ...
                + "    public static class PersonLens<HOST> extends ObjectLensImpl<HOST, Person> {\n"
                + "        \n"
                + "        public final ListLens<HOST, Object, ObjectLens<HOST, Object>> children = createSubListLens(Person::children, Person::withChildren);\n"
                + "        \n"
                + "        public PersonLens(LensSpec<HOST, Person> spec) {\n"
                + "            super(spec);\n"
                + "        }\n"
